...
class OmnigraphClient:
    ...
    def _execute(self, endpoint, query_filename, params=None):
        """
    ...
    def insert_account(self, name, node_key, risk_score):
        """
        ...
        return self._execute("change", "insert_account.gq", params)

    def get_account(self, node_key):
        """
        ...
        return self._execute("read", "get_account.gq", params)
